...
Тепер магія полягає у тому, що з цього моменту ми можемо віднаслідуватись класами `Image` та `Person` від абстрактних `Job` та `Worker` і запустити виконання на них. Ще одна магія полягає у тому, що не маючи жодного стосунку до "академічного" розв'язання цієї задачі за допомогою ділення, вона виконується динамічно на окремих потоках і всерівно дає такий самий результат, як і ділення - тут ми підтвердили наукову гіпотезу :D
